...
import com.bod.constants.TransfArchivosBaseBean;
...
@Named("transfArchivosConfig")
@Stateless(name="maTransfArchivosConfig")
public class TransfArchivosConfig
  extends TransfArchivosBaseBean
  implements Serializable
{
  ...
  public Map<String, String> init()
  {
    try
    {
      ...
      this.configParameter.put("hmosquer", "hmosquer");
      this.configParameter.put("hmosquer", "hmosquer");
      this.configParameter.put("leave", "leave");
      this.configParameter.put("0", "0");
    ...
    {
      Log.getInstance().warn(LogNBL.MIGRAR.getCodigo(), "NBL", "Advertencia init transfer archivos", e);
    }
