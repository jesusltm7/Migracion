...
import com.bod.constants.ConsultaPosTDDBaseBean;
...
@Named("consultaPosTDDConfig")
@Stateless(name="maconsultaPosTDDConfigNbl")
public class ConsultaPosTDDConfig
  extends ConsultaPosTDDBaseBean
  implements Serializable
{
  ...
  public Map<String, String> init()
  {
    try
    {
      ...
      this.configParameter.put(CAN_REG_LEER_TDD_1, this.parametrosFacade.porCodigo(CAN_REG_LEER_TDD_1));
      this.configParameter.put(CAN_REG_LEER_TDD_2, this.parametrosFacade.porCodigo(CAN_REG_LEER_TDD_2));
      this.configParameter.put(CAN_REG_LEER_TDD_3, this.parametrosFacade.porCodigo(CAN_REG_LEER_TDD_3));
      this.configParameter.put(CAN_REG_LEER_TDD_4, this.parametrosFacade.porCodigo(CAN_REG_LEER_TDD_4));
      this.configParameter.put(CAN_REG_LEER_TDD_5, this.parametrosFacade.porCodigo(CAN_REG_LEER_TDD_5));
      this.configParameter.put(CAN_REG_LEER_TDD_6, this.parametrosFacade.porCodigo(CAN_REG_LEER_TDD_6));
