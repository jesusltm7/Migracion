...
import com.bod.constants.TransferenciasBaseBean;
...
@Named("transferenciasConfig")
@Stateless(name="maTransferenciasConfig")
public class TransferenciasConfig
  extends TransferenciasBaseBean
  implements Serializable
{
  ...
  public Map<String, String> init()
  {
    ...
    {
      Log.getInstance().warn(LogNBL.MIGRAR.getCodigo(), "NBL", "Advertencia init transferencias", e);
    }
