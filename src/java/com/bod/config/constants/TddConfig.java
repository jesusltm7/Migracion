...
import com.bod.constants.TddBaseBean;
  ...
  implements Serializable
{
  ...
  public Map<String, String> init()
  {
    try
    {
      ...
      this.configParameter.put(TDD_ESTATUS_SUSPENDIBLES, this.parametrosFacade.porCodigo(TDD_ESTATUS_SUSPENDIBLES));
      this.configParameter.put(DIR_BANK_ID_05, this.parametrosFacade.porCodigo(DIR_BANK_ID_05));
